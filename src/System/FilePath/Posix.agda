...
postulate
  ...
  splitFileName : FilePath → Pair FilePath String
...
{-# COMPILE GHC splitFileName = fmap pack . splitFileName #-}
{-# COMPILE GHC takeFileName = pack . takeFileName #-}
{-# COMPILE GHC replaceFileName = fmap (. unpack) replaceFileName  #-}
